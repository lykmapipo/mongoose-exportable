...
import { Query, Aggregate, isQuery, eachPath, isNumber, isString } from '@lykmapipo/mongoose-common';
...
const exportablePlugin = (schema) => {
   ...
   * readableStream.pipe(...);
   */
  Aggregate.prototype.exportCsv = function exportCsv(optns, writeStream, cb) {
    // normalize argurments
...
export { exportablePlugin as default };
